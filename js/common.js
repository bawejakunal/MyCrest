...
var common = (function() {
  ...
  function handleMessage(message_event) { 
    ...
    { 
      if (message_event.data.action.toString() === 'encryption')
      { 
        completeUpload(message_event.data);
        return;
      }
      else if (message_event.data.action.toString() === 'decryption')
      {
        completeDownload(message_event.data);
        return;
      }
      else if(message_event.data.action.toString() === 'osetup')
      {
        completeUbeKeygen(message_event.data);
        return;
      }
      else if(message_event.data.action.toString() === 'share')
      {
